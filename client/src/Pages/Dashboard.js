...
export default function Dashboard() {
  ...
  const t = {
    ...
    fr: {
      ...
      messages: "Messages", // Keep translation just in case, or remove if desired. Keeping for now but unused in UI.
      settings: "Paramètres",
      ...
      saved: "Enregistré!",
      resumeUpload: "Téléversement de CV",
      uploadEn: "Téléverser le CV en anglais (PDF)",
      uploadFr: "Téléverser le CV en français (PDF)",
      currentFile: "Fichier actuel :",
      uploadSuccess: "CV téléversé avec succès !",
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [commentsRes, projectsRes, statsRes, contactRes] = await Promise.all([
